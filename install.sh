...
sleep 2
echo $pur"Bila Ada Kesalahan Kami Mohon Maaf"
sleep 2
echo $ku"Instagram :"$i" Wisnu_as123"
echo $ku"YouTube  :"$i" DSV plankton"
echo $ku"WhatsApp :"$i" 085718955758"
sleep 2
echo $pur"Terima kasih Yang Sudah Support dengan Tools ini"
sleep 2
echo $pur"SUBSCRIBE YOUTUBE { DSV plankton }"
exit
fi
